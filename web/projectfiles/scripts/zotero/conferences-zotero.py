...
collectionID = ('ZIZIUZK7') #chapters collectionID
zot.add_parameters(content='bib', style='turabian-fullnote-bibliography', itemType='-attachment')
...
with open('web/projectfiles/templates/zotero/conferences-bibliography.html', 'w') as f:
